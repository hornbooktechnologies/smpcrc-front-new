			...
			<main className='flex-grow'>
				...
				<section className='relative h-[400px] w-full overflow-hidden'>
					...
					<div className='relative mx-auto flex h-full max-w-7xl flex-col justify-center px-4 sm:px-6 lg:px-8'>
						...
						>
							Sardar Patel Medical College & Research Center is dedicated to
							providing excellence in medical education and healthcare. Reach
							out to us for any queries.
						</motion.p>
					</div>
				</section>
					...
					<div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
						...
						>
							...
							<p className='mt-2 text-sm text-slate-500'>
								Sardar patel medical college Near 108, emergency centre Nava
								Naroda, Ahmedabad, Gujarat 382350
							</p>
						</motion.div>
